...
코드, 설정, 데이터, 문서, 결과물의 무단 사용을 금지합니다. 특히 다음 목적의 사용은 사전 서면 허가 없이 금지됩니다.

- 논문, 학위논문, 학술대회, 저널, 연구보고서 등 학술적 산출물에 사용하는 행위
- 상업적 제품, 서비스, 컨설팅, 특허, 기술이전, 유료 연구개발에 사용하는 행위
- 코드 복사, 수정, 재배포, 파생 프로젝트 생성
- 실험 결과, figure, table, method implementation을 외부 산출물에 재사용하는 행위
